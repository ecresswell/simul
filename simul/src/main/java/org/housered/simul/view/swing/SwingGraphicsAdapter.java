...
public class SwingGraphicsAdapter implements GraphicsAdapter
{
    ...
    @Override
    public void drawVector(Vector origin, Vector direction)
    {
    ...
    @Override
    public void drawLine(Vector firstPoint, Vector secondPoint)
    {
        IntVector o = new IntVector(camera.translateIntoScreenSpace(firstPoint));
        IntVector t = new IntVector(camera.translateIntoScreenSpace(secondPoint));
