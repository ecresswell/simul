...
public class CityPlanner
{
    ...
    public CityPlanner(IdGenerator idGenerator, GameClock gameClock, AssetManager assetManager,
            CommercialManager commercialManager, NavigationManager navigationManager,
    ...
    {
        PersonFactory personFactory = new PersonFactory(idGenerator, assetManager, commercialManager,
                navigationManager, gameClock, roadNetworkManager);
