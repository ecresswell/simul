...
/**
 * Representation of a two-lane road section for one direction. The main elements of MicroStreet are
 * <ul>
 * <li>street, a vector of Moveable's representiung the vehicles,
 * <li>The update method invoked in every time step. Ammong others, it calls all emthods mentioned
 * below.
 * <li>Methods for moving the vehicles (translate), accelerating them (accelerate) and performing
 * the lane changes (changeLanes).
 * <li>A sorting routine sort for rearranging the vehicle order in street in the order of decreasing
 * longitudinal positions
 * <li>The method ioFlow implementing the upstrea and downstream boundary conditions (inflow and
 * outflow).
 * </ul>
 * <br>
 * <br>
...
public class MicroStreet implements Constants
{
    ...
    /*
     * <Treiber aug06> Methode veraendert, so dass auch bei 0 Fz auf beiden Spuren neue Fz
     * eingefuehrt werden koennen (Ringstrasse) </Treiber>
     */
