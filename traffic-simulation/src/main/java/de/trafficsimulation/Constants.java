...
/**
 * An assortment of constants influencing the global appearance and functionality of the applet. In
 * many cases, the applet can be adapted to special needs (e.g. a different applet size, different
 * time steps, different truck percentage etc) by simply changing some numbers here and recompiling.
 */
