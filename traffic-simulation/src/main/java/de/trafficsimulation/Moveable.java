...
/**
 * Moveable represents a general vehicle object with position, velocity eyc. In each time step, the
 * objects are updated by moving them forward (method translate), by changing the velocity (method
 * accelerate), and, in time steps where timeToChange return true, by possibly changing the lane
 * (method change) <br>
 * <br>
 ...
 * <li>BCCar: These are introduced for bookkeeping purposes, only to make sure that any Car has a
 * predecessor required for calculating the acceleration.
 * </ul>
 */
