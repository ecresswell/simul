...
public class SimCanvas extends Canvas implements Runnable, Constants
{
    ...
    /**
     * draw the speed color code if colorCode==1 if condition is at the calling location, calls
     * final method VehicleImage2D.colormapSpeed(...) xrel=0..1 from left, yrel=0..1 from bottom
     */
