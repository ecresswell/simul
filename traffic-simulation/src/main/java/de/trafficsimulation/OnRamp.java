...
public class OnRamp extends MicroStreet
{
    ...
    private void mergeToMainRoad(LaneChange laneChangeModel, double mergingPos)
    {
        ...
        if (imax >= 1)
        { // at least one real vehicle on the ramp lane
         ...
         * System.out.println(" Vehicles on main road:"); for (int i=0; i<mainroad.street.size();
         * i++){ double pos = ((Moveable) mainroad.street.elementAt(i)).position();
         * System.out.println("  i="+i+", pos="+pos); }
         * System.out.println(" Vehicles on  on-ramp:"); for (int i=0; i<street.size(); i++){ double
         * pos = ((Moveable) street.elementAt(i)).position();
         * System.out.println("  i="+i+", pos="+pos); }
         */
    }
